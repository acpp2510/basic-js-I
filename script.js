...
//Escribe tu código aquí
let lastName = "Pillajo" //string
let age = 35 //number
let married = false //boolean
let empty  = null //null
let datepPregnancy = undefined //undefined
let identify  = { lastName: "Pillajo", age: 35 } //object
let array = [3, 6, 9, 12] //array
...
//Escribe tu código aquí
const coder = { nombre: "Ana Carina", edad: 35 }
console.log(coder)
...
typeof age //number
typeof married //boolean    
typeof empty //null
typeof datepPregnancy //undefined   
...
//Escribe tu código aquí
let multiply = 200 * 4 //multiplicación
...
let opcionA = 1
let opcionB = 2
console.log(opcionA == opcionB) // comparación de igualdad
...
let compare = opcionA != opcionB // comparación de desigualdad
console.log(compare) 
...
//Escribe tu código aquí
let nombre = "Ana Carina"
let apellido = "Pillajo Pelisita"
